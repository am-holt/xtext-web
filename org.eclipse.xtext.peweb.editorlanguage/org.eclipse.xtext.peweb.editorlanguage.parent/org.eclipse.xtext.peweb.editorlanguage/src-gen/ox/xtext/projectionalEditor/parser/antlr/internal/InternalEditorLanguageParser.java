        ...
        try {
                ...
                case 1 :
                    ...
                    state._fsp--;
                    					...
                    					set(
                    						...
                    						"imports",
                    						lv_imports_0_0,
                    						"ox.xtext.projectionalEditor.EditorLanguage.ImportSection");
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"mainSection",
            						lv_mainSection_1_0,
            						"ox.xtext.projectionalEditor.EditorLanguage.MainSection");
            					afterParserOrEnumRuleCall();
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    					...
            	    					add(
            	    						...
            	    						"imports",
            	    						lv_imports_1_0,
            	    						"ox.xtext.projectionalEditor.EditorLanguage.Import");
            	    					afterParserOrEnumRuleCall();
        ...
        try {
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"name",
            						lv_name_1_0,
            						"ox.xtext.projectionalEditor.EditorLanguage.QualifiedName");
            					afterParserOrEnumRuleCall();
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    						...
            	    						add(
            	    							...
            	    							"nodes",
            	    							lv_nodes_1_0,
            	    							"ox.xtext.projectionalEditor.EditorLanguage.NodeDeclaration");
            	    						afterParserOrEnumRuleCall();
            	...
            	case 2 :
            	    ...
            	    state._fsp--;
            	    						...
            	    						add(
            	    							...
            	    							"components",
            	    							lv_components_2_0,
            	    							"ox.xtext.projectionalEditor.EditorLanguage.ComponentDeclaration");
            	    						afterParserOrEnumRuleCall();
        ...
        try {
            ...
            lv_nodeName_1_0=(Token)match(input,RULE_ID,FOLLOW_8); 
            					...
            					setWithLastConsumed(
            						...
            						"nodeName",
            						lv_nodeName_1_0,
            						"ox.xtext.projectionalEditor.EditorLanguage.ID");
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    						...
            	    						add(
            	    							...
            	    							"projections",
            	    							lv_projections_3_0,
            	    							"ox.xtext.projectionalEditor.EditorLanguage.ProjectionDeclaration");
            	    						afterParserOrEnumRuleCall();
        ...
        try {
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"view",
            						lv_view_4_0,
            						"ox.xtext.projectionalEditor.EditorLanguage.HtmlSnippet");
            					afterParserOrEnumRuleCall();
            	...
            	case 1 :
            	    ...
            	    state._fsp--;
            	    						...
            	    						add(
            	    							...
            	    							"attributes",
            	    							lv_attributes_5_0,
            	    							"ox.xtext.projectionalEditor.EditorLanguage.AttributeDeclaration");
            	    						afterParserOrEnumRuleCall();
        ...
        try {
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"controller",
            						lv_controller_2_0,
            						"ox.xtext.projectionalEditor.EditorLanguage.AttributeController");
            					afterParserOrEnumRuleCall();
        ...
        try {
            ...
            state._fsp--;
            					...
            					set(
            						...
            						"getter",
            						lv_getter_2_0,
            						"ox.xtext.projectionalEditor.EditorLanguage.JsSnippet");
            					afterParserOrEnumRuleCall();
                ...
                case 1 :
                    ...
                    state._fsp--;
                    					...
                    					set(
                    						...
                    						"control",
                    						lv_control_3_0,
                    						"ox.xtext.projectionalEditor.EditorLanguage.ComponentController");
                    					afterParserOrEnumRuleCall();
                ...
                case 1 :
                    ...
                    state._fsp--;
                    						...
                    						add(
                    							...
                    							"html",
                    							lv_html_1_0,
                    							"ox.xtext.projectionalEditor.EditorLanguage.CodeLiteral");
                    						afterParserOrEnumRuleCall();
                ...
                case 2 :
                    ...
                    state._fsp--;
                    						...
                    						add(
                    							...
                    							"html",
                    							lv_html_2_0,
                    							"ox.xtext.projectionalEditor.EditorLanguage.CodeLiteralStart");
                    						afterParserOrEnumRuleCall();
                    ...
                    state._fsp--;
                    						...
                    						add(
                    							...
                    							"html",
                    							lv_html_3_0,
                    							"ox.xtext.projectionalEditor.EditorLanguage.HtmlAnnotation");
                    						afterParserOrEnumRuleCall();
                    	...
                    	case 1 :
                    	    ...
                    	    state._fsp--;
                    	    							...
                    	    							add(
                    	    								...
                    	    								"html",
                    	    								lv_html_4_0,
                    	    								"ox.xtext.projectionalEditor.EditorLanguage.CodeLiteralMid");
                    	    							afterParserOrEnumRuleCall();
                    ...
                    state._fsp--;
                    						...
                    						add(
                    							...
                    							"html",
                    							lv_html_6_0,
                    							"ox.xtext.projectionalEditor.EditorLanguage.CodeLiteralEnd");
                    						afterParserOrEnumRuleCall();
        ...
        try {
            ...
            lv_value_0_0=(Token)match(input,RULE_CODENOTAG,FOLLOW_2); 
            				...
            				setWithLastConsumed(
            					...
            					"value",
            					lv_value_0_0,
            					"ox.xtext.projectionalEditor.EditorLanguage.CODENOTAG");
        ...
        try {
            ...
            lv_value_0_0=(Token)match(input,RULE_CODESTART,FOLLOW_2); 
            				...
            				setWithLastConsumed(
            					...
            					"value",
            					lv_value_0_0,
            					"ox.xtext.projectionalEditor.EditorLanguage.CODESTART");
        ...
        try {
            ...
            lv_value_0_0=(Token)match(input,RULE_CODEMID,FOLLOW_2); 
            				...
            				setWithLastConsumed(
            					...
            					"value",
            					lv_value_0_0,
            					"ox.xtext.projectionalEditor.EditorLanguage.CODEMID");
        ...
        try {
            ...
            lv_value_0_0=(Token)match(input,RULE_CODEEND,FOLLOW_2); 
            				...
            				setWithLastConsumed(
            					...
            					"value",
            					lv_value_0_0,
            					"ox.xtext.projectionalEditor.EditorLanguage.CODEEND");
                ...
                case 2 :
                    ...
                    state._fsp--;
                    						...
                    						add(
                    							...
                    							"js",
                    							lv_js_3_0,
                    							"ox.xtext.projectionalEditor.EditorLanguage.JsExtraTag");
                    						afterParserOrEnumRuleCall();
