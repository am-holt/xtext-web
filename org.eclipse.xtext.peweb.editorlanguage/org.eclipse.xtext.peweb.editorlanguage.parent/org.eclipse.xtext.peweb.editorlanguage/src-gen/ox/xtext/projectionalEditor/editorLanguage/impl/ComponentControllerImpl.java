 ...
 * </p>
 * <ul>
 *   <li>{@link ox.xtext.projectionalEditor.editorLanguage.impl.ComponentControllerImpl#getView <em>View</em>}</li>
 *   <li>{@link ox.xtext.projectionalEditor.editorLanguage.impl.ComponentControllerImpl#getGetter <em>Getter</em>}</li>
 *   <li>{@link ox.xtext.projectionalEditor.editorLanguage.impl.ComponentControllerImpl#getSetter <em>Setter</em>}</li>
 *   <li>{@link ox.xtext.projectionalEditor.editorLanguage.impl.ComponentControllerImpl#getValidater <em>Validater</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentControllerImpl extends MinimalEObjectImpl.Container implements ComponentController
{
  ...
  public NotificationChain basicSetValidater(JsSnippet newValidater, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EditorLanguagePackage.COMPONENT_CONTROLLER__VALIDATER, oldValidater, newValidater);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setValidater(JsSnippet newValidater)
  {
    if (newValidater != validater)
    {
      NotificationChain msgs = null;
      if (validater != null)
        msgs = ((InternalEObject)validater).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EditorLanguagePackage.COMPONENT_CONTROLLER__VALIDATER, null, msgs);
      if (newValidater != null)
        msgs = ((InternalEObject)newValidater).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EditorLanguagePackage.COMPONENT_CONTROLLER__VALIDATER, null, msgs);
      msgs = basicSetValidater(newValidater, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EditorLanguagePackage.COMPONENT_CONTROLLER__VALIDATER, newValidater, newValidater));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case EditorLanguagePackage.COMPONENT_CONTROLLER__VALIDATER:
