...
class CreateProjectServiceTest extends AbstractAPIServiceTester {
	...
	void testMissingParameter(String param) {
		...
		callParameters.put("serviceType", "add-project");
		callParameters.put("name", "proj");
