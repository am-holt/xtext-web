...
class AddNodeReferenceServiceTest extends AbstractAPIServiceTester {
	...
	void testMissingParameter(String param) {
		...
		callParameters.put("serviceType", "add-reference");
		...
		callParameters.put("cross-reference", "true");
	...
	//Test to ensure no cross-reference parameter throws an exception
	@Test
	void testMissingReferenceIdParameter() {
		testMissingParameter("cross-reference");
	}
